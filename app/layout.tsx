...
export const metadata: Metadata = {
  ...
  description: "Portfolio of a senior full-stack engineer with 19+ years of experience in web and mobile development for enterprise and public sector clients.",
};
