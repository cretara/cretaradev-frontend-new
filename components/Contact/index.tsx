          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            ...
            >
              ...
              <p className="mb-12 text-base font-medium text-body-color">
                I'm always interested in discussing new opportunities, innovative projects, or potential collaborations. Get in touch and let's create something amazing together.
              </p>
              <form>
                <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
            ...
            >
              ...
              <p className="mb-7 text-base font-medium text-body-color">
                Ready to discuss your next project? I'm available for consulting, full-time opportunities, and collaboration.
              </p>
