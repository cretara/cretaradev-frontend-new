            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  Full-stack engineer with 19+ years of experience creating innovative solutions for enterprise and public sector clients. Passionate about technology and open-source development.
                </p>
