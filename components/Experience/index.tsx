  ...
  const experiences = [
    {
      ...
      description: "Leading architecture design and development of enterprise-scale applications. Managing cross-functional teams and implementing best practices for scalable solutions.",
    ...
    },
    {
      ...
      description: "Spearheaded digital transformation initiatives for public administration systems. Developed citizen-facing portals and internal workflow automation tools.",
    ...
    },
    {
      ...
      description: "Built secure banking and financial applications with focus on compliance and security. Implemented real-time transaction processing systems.",
    ...
    },
    {
      ...
      description: "Developed HIPAA-compliant healthcare management systems. Created patient portals and integrated with various medical devices and systems.",
    ...
    },
    {
      ...
      description: "Started career developing custom websites and web applications for small to medium businesses. Gained experience in multiple technologies and frameworks.",
          ...
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              ...
              <p className="text-base font-medium leading-relaxed text-body-color">
                Over 17 years of progressive experience in software development, from junior developer to senior architect.
              </p>
            </div>
          </div>
        </div>
